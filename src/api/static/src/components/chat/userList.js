                                ...
                                {this.props.users.users && this.props.users.users.map((user, i) => {
                                    ...
                                    return (
                                        <Table.Row key={i} error={user.reports > 0}>
                                            ...
                                            <Table.Cell>
                                                <Link target='_blank' to={"/users/edit/" + user.uid} >
                                                    <Icon link name="pencil" size="large" color="blue"/>
                                                </Link>
                                                {!chats[user.uid] && <Icon link name="chat" size="large" color="blue" onClick={ e => {this.props.startNewChat(this.props.fakeUserId, user.uid);} }/>}
                                            </Table.Cell>
                                        </Table.Row>
                                    );
                                })}
